// Small hand-authored Lucide-style line icons — matches the design handoff's inline
// SVGs (stroke currentColor, stroke-width 2, round caps). No icon library dependency
...
export function LogoMark({ size = 26 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#4338ca" strokeWidth={1.8}>
...
export function FileTextIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#667085" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
